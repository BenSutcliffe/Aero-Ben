...
t=33.6 #choose t to also find stability value at time t printed in terminal #markers are actual COP points to compare to graph fit
...
#for flutter. edit fin dimensions and stuff in flutter file. bit janky unfortunately.
